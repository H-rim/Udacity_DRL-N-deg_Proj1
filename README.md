...
#### State
37-D vector
- contains the agent's velocity, along with ray-based perception of objects around agent's forward direction, etc.
...
Follow the instructions in `code/Navigation.ipynb` to get started with training your own agent!  